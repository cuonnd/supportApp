...
export const GeneratorTool: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setError("Failed to generate image. Please try again or adjust your prompt.");
    } finally {
  ...
  const handleDownload = () => {
    if (resultImage) {
      ...
      link.download = `wowai-gen-${Date.now()}.jpg`;
  ...
  return (
    <div className="max-w-4xl mx-auto w-full animate-fade-in-up">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">AI Image Generator</h2>
        <p className="text-gray-400">Turn your imagination into reality with a simple description.</p>
      </div>
